...
export default compose(connect(mapStateToProps, {follow, unfollow, setCurrentPage, setMinMaxPages, setIsFollowingProgress, getUsers}), withAuthRedirect)(UsersContainer);